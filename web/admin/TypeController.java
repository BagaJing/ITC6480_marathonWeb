...
public class TypeController {
    ...
    public String post(@Valid Type type, BindingResult result, RedirectAttributes attributes) {
        ...
        if (type1 != null){
            result.rejectValue("name","nameError","cannot add a existing type");
        }
        if (result.hasErrors()){
            return "admin/types-input";
        }
        ...
        if (t == null) {
            ...
            //
            attributes.addFlashAttribute("message","Submit Successfully");
        }
    ...
    public String delete(@PathVariable Long id,
        ...
        attributes.addFlashAttribute("message","Successfully delete");
        return "redirect:/admin/types";
    }
}
